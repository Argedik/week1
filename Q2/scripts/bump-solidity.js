...
// Groth 16
let content2 = fs.readFileSync("./contracts/Multiplier3Verifier_groth16.sol", {
  encoding: "utf-8",
});
let bumped2 = content2.replace(solidityRegex, "pragma solidity ^0.8.0");
bumped2 = bumped2.replace(
  verifierRegex,
  "contract Multiplier3Verifier_groth16"
);

fs.writeFileSync("./contracts/Multiplier3Verifier_groth16.sol", bumped2);
